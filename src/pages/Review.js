...
//           <section className=' bg-white  rounded-lg shadow-lg shadow-gray-400'>
//             <div className='flex items-center flex-col px-3 py-2 md:flex-row justify-between'>
//               <h1 className='text-[24px] md:text-[28px] font-semibold'>Appointments</h1>
//               <div className='text-sm font-semibold text-center md:text-right mt-2 md:mt-0'>
//                 Dashboard<span className='text-[#007569]'>{'>'}Appointments </span>
//               </div>
//             </div>
...
//             <div className='rounded-lg bg-[#F7F7F7] border mx-5 border-[#BEBEBE] mt-5 mb-5'>
//               {activeTab === 'all review' && (
//                 <div className="p-4 flex gap-3  ">
//                   <div className='flex items-center'>
//                     <div className=' lg:h-[160px] lg:w-[200px] md:h-[170px] md:w-[170px]  h-[50px] w-[50px]  p-2 mx-auto'>
//                       <img className='    lg:h-[160px] lg:w-[200px] md:h-[170px] md:w-[170px]  h-[50px] w-[50px] overflow-hidden  bg-[#017A884D]' src="doctor1.png" alt='doctor' />
//                     </div>

//                     <div className='flex flex-col gap-2'>
//                       <div className='flex gap-2'> <h2 className='text-[#007569] md:text-xl font-bold leading-9 text-sm'>Name</h2>
//                         <p className="text-[#F89603] text-xl ">★★★★★</p>
//                       </div>
//                       <p className='md:text-[16px] text-start text-semibold leading-[28.21px] text-sm'> I am very much glad to note my feedback and grateful. Thanks to Dr. Chibber and assistants. I got very good guidelines for my patient.</p>
//                       <p className=' text-start mt-2 text-xs text-gray-600 font-semibold'>date and time </p>
//                     </div>
//                   </div>
...
//                     <p className='text-[#007569] md:text-xl font-semibold leading-9 text-sm'>cold and flu</p>
//                   </div>
                ...
                <div key={index} className="p-4 flex gap-3">
                  <div className='flex items-center'>
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <p className='text-start mt-2 text-xs text-gray-600 font-semibold'>{review.date}</p>
                    </div>
                  </div>
